...
async def listar_avaliacoes(request: Request):
    return templates.TemplateResponse("cuidador/avaliacoes/realizadas.html", {"request": request, "avaliacoes": avaliacoes})
...
async def confirmar_exclusao(request: Request, id: int):
    ...
    return templates.TemplateResponse("cuidador/avaliacoes/excluir.html", {"request": request, "avaliacao": avaliacao})
...
async def get_alterar_avaliacao(request: Request, id: int):
    avaliacao = next((a for a in avaliacoes if a["id"] == id), None)
    return templates.TemplateResponse("cuidador/avaliacoes/alterar.html", {"request": request, "avaliacao": avaliacao})
